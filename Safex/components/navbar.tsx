...
export const Navbar = () => {
  ...
  // Update currentRoute when pathname changes
  useEffect(() => {
      ...
      <NavbarContent className="basis-1/5 sm:basis-full" justify="start">
        ...
        <nav className="hidden lg:flex ml-2">
          <AnimatedTabs
            ...
            tabClassName="text-sm font-medium text-white dark:text-gray-300 hover:bg-[#00b7ff] dark:hover:bg-[#7828c8] hover:text-white dark:hover:text-white px-4 py-1.5 rounded-full transition-colors duration-400 ease-in-out text-center bg-transparent"
            activeTabClassName="bg-[#00b7ff] dark:bg-[#7828c8] text-white dark:text-white rounded-full transition-colors duration-400 ease-in-out text-center px-4 py-1.5"
